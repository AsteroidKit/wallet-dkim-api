...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log("Account balance:", (yield deployer.getBalance()).toString());
        ...
        console.log("DkimChecker address: " + dkimChecker.address);
        const scwDeployer = yield SCWDeployer.deploy(dkimChecker.address);
        console.log("SCWDeployer address: " + scwDeployer.address);
    });
}
